package org.easyarch.leaf.kits.file;
...
/**
 * Created by xingtianyu(code4j) on 2017-8-22.
 */
public class FileKits {
    ...
    public static List<File> filter(File file, org.easyarch.leaf.kits.file.FileFilter filter){
        if (file == null){
            return null;
        }
        List<File> paths = new ArrayList<File>();
    ...
    public static List<File> filter(String path, org.easyarch.leaf.kits.file.FileFilter filter){
